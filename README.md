...
web.py comes with an extension, file.py, that allows one to specify the local directory and the remote resource and add the extension's routes to the main list.
